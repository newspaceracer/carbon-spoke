...
// Keyed by `statusKind` (a valid cds-icon-indicator kind, see permits.ts). `type`
// is the cds-tag colour; the path draws the matching Carbon glyph.
const statusStyle: Record<string, { type: string; viewBox: string; path: string }> = {
  ...
  unknown:        { type: 'cool-gray', viewBox: '0 0 32 32', path: 'M16,30A14,14,0,1,1,30,16,14,14,0,0,1,16,30ZM16,4A12,12,0,1,0,28,16,12,12,0,0,0,16,4Z M20.5859,23,15,17.4141V8h2v8.5859l5,5.0009Z' },
  'not-started':  { type: 'gray',      viewBox: '0 0 32 32', path: 'M25.7,9.3l-7-7A1,1,0,0,0,18,2H8A2,2,0,0,0,6,4V28a2,2,0,0,0,2,2H24a2,2,0,0,0,2-2V10A1,1,0,0,0,25.7,9.3ZM18,4.4L23.6,10H18ZM24,28H8V4h8v6a2,2,0,0,0,2,2h6Z' },
  pending:        { type: 'cyan',      viewBox: '0 0 32 32', path: 'M16,2A14,14,0,1,0,30,16,14,14,0,0,0,16,2ZM8,18a2,2,0,1,1,2-2A2,2,0,0,1,8,18Zm8,0a2,2,0,1,1,2-2A2,2,0,0,1,16,18Zm8,0a2,2,0,1,1,2-2A2,2,0,0,1,24,18Z' },
  'caution-minor':{ type: 'purple',    viewBox: '0 0 32 32', path: 'M16,23a1.5,1.5,0,1,0,1.5,1.5A1.5,1.5,0,0,0,16,23Z M15,12h2v9h-2z M29,30H3a1,1,0,0,1-.8872-1.4614l13-25a1,1,0,0,1,1.7744,0l13,25A1,1,0,0,1,29,30ZM4.6507,28H27.3493l.0011-.0033L16,6.1662,4.6493,27.9967Z' },
  ...
  undefined:      { type: 'warm-gray', viewBox: '0 0 32 32', path: 'M16,2A14,14,0,1,0,30,16,14,14,0,0,0,16,2Zm0,26A12,12,0,1,1,28,16,12,12,0,0,1,16,28Z M8,15H24v2H8Z' },
};
